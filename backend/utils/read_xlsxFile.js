...
try {
    const workbook = XLSX.readFile("C:\\Users\\AnyRicmo\\Downloads\\GOMOA WEST NOMINAL ROLL 2024-2025.xlsx");
    ...
    const outputFilePath = 'processed_data.xlsx'; // Choose your desired output file name
